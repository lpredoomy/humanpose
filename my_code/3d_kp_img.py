...
def main(pose_lifter_config, pose_lifter_checkpoint):
...
if __name__ == '__main__':
    pose_lifter_config = 'configs/body/3d_kpt_sview_rgb_img/pose_lift/h36m/simplebaseline3d_h36m.py'
    pose_lifter_checkpoint = 'simple3Dbaseline_h36m-f0ad73a4_20210419.pth'
    main(pose_lifter_config,pose_lifter_checkpoint)
